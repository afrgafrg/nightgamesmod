...
public class AiriTime extends BaseNPCTime {
    ...
    public void subVisit(String choice) {
        if (choice.equals("Rush over")) {
            GUI.gui.loadPortrait("airi_mostly_human.jpg");
            GUI.gui.showPortrait();
            GUI.gui.message("She doesn't immediately respond to you, so you try to examine her to see if there's something you can do. As you try to turn her head to check if she's conscious, "
            ...
            choose("Stand Up", GUI.gui);
        } else if (choice.equals("Stand Up")) {
            GUI.gui.loadPortrait("airi_mostly_slime.jpg");
            GUI.gui.showPortrait();
            GUI.gui.message("As you're about to walk away, you are suddenly knocked to the floor from behind. When you try to turn around to see what's the big deal, you find Airi's crimson staring into yours."
            ...
            GUI.gui.loadPortrait("airi_mostly_slime.jpg");
            GUI.gui.showPortrait();
            GUI.gui.message(Formatter.format("You know that Airi, while appearing kind of shy at first, has an incredible appetite for sex thanks to her condition. You try broaching the subject with her, hoping that she can help you with the boner that's been developing "
                            ...
                            + "and gives you a sweet kiss. <i>\"That was fun, and the fluids really helped me out. Uhm... let's do it again soon okay?\"</i>", GameState.gameState.characterPool
                            .getCharacterByType("Airi"), GameState.gameState.characterPool.getPlayer()));
            ...
            GUI.gui.loadPortrait("airi_mostly_slime.jpg");
            GUI.gui.showPortrait();
            GUI.gui.message(Formatter.format("You suggest doing some practice to Airi, seeing how she's not incredibly physically fit. You tell her that being a bit stronger will help her in the night games when she doesn't make use of her slime form. Airi seems a bit hesistant at first but agrees when "
                            ...
                            + "Defeated, you can only sigh in resignation. Looks like you have a couple of expensive dates soon.", GameState.gameState.characterPool
                            .getCharacterByType("Airi"), GameState.gameState.characterPool.getPlayer()));
            ...
            GUI.gui.loadPortrait("airi_human.jpg");
            GUI.gui.showPortrait();
            GUI.gui.message(Formatter.format("[Placeholder]You play monster hunter with Airi.", GameState.gameState.characterPool.getCharacterByType("Airi"), GameState.gameState.characterPool
                            .getPlayer()));
