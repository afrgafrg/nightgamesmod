...
public class BlackMarket extends Store {
    ...
    public void visit(String choice) {
        ...
        checkSale(choice);
        if (player.human()) {
            if (Global.global.checkFlag(Flag.blackMarketPlus)) {
                if (!Global.global.checkFlag(Flag.metRin)) {
                    ...
                    Global.global.flag(Flag.metRin);
                    ...
                    Global.global.flag(Flag.darkness);
                    acted = true;
                    ...
                    if (player.money >= 1000 * (player.getPure(Attribute.Dark) + 1)) {
                        ...
                        Global.global.gui().message("You can't afford the artifacts.");
                    }
                    ...
                    Global.global.flag(Flag.fetishism);
                    acted = true;
                    ...
                    if (player.money >= 1000 * (player.getPure(Attribute.Fetish) + 1)) {
                        ...
                        Global.global.gui().message("You can't afford that.");
                    }
                } else {
                    Global.global.gui().message(
                ...
                if (!trained) {
                    if (!Global.global.checkFlag(Flag.darkness)) {
                        Global.global.gui().choose(this, "Cursed Artifacts");
                    } else {
                        Global.global.gui().choose(this, "Dark Power: $" + 1000 * (player.getPure(Attribute.Dark) + 1));
                    }
                    if (!Global.global.checkFlag(Flag.fetishism)) {
                        Global.global.gui().choose(this, "S&M Gear");
                    } else {
                        Global.global.gui()
                                        .choose(this, "Fetishism: $" + 1000 * (player.getPure(Attribute.Fetish) + 1));
                    }
                }
            } else {
                Global.global.gui().message(
        ...
        while (remaining > 25 && bored < 5) {
            for (Item i : stock.keySet()) {
                ...
                if (i.equals(Item.PriapusDraft)) {
                    if (Global.global.random(10) > Global.global.getValue(Flag.malePref)) {
                        bored++;
                        continue;
                    }
                    max = 1;
