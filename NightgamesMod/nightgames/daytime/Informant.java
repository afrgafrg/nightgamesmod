...
public class Informant extends Activity {
    ...
    public void visit(String choice) {
        ...
        if (!Global.global.checkFlag(Flag.metBroker)) {
            ...
            Global.global.flag(Flag.metBroker);
            Global.global.gui()
                  .choose(this, "Leave");
            acted = true;
            return;
        } else if (player.getRank() >= 1 && !Global.global.checkFlag(Flag.rank1)) {
            Global.global.gui()
        ...
        if (choice.equals("Purchasing supplies")) {
            ...
            Global.global.flag(Flag.basicStores);
            Global.global.gui()
                  .choose(this, "Leave");
            acted = true;
            return;
        ...
        if (choice.equals("The Competition")) {
            ...
            Global.global.flag(Flag.girlAdvice);
            Global.global.gui()
                  .choose(this, "Leave");
            acted = true;
            return;
        ...
        if (choice.equals("Meditation: $200")) {
            if (player.money >= 200) {
                ...
                Global.global.flag(Flag.meditation);
                player.money -= 200;
                Global.global.gui()
                      .choose(this, "Leave");
                acted = true;
        ...
        if (choice.equals("Black Market: $400")) {
            if (player.money >= 400) {
                ...
                Global.global.flag(Flag.blackMarket);
                player.money -= 400;
                Global.global.gui()
                      .choose(this, "Leave");
                acted = true;
        ...
        if (choice.equals("Cassie: $300")) {
            if (player.money >= 300) {
                ...
                Global.global.flag(Flag.CassieKnown);
                player.money -= 300;
                Global.global.gui()
                      .choose(this, "Leave");
                acted = true;
        ...
        if (choice.equals("Angel: $300")) {
            if (player.money >= 300) {
                ...
                Global.global.flag(Flag.AngelKnown);
                player.money -= 300;
                Global.global.gui()
                      .choose(this, "Leave");
                acted = true;
        ...
        if (choice.equals("Mara: $300")) {
            if (player.money >= 300) {
                ...
                Global.global.flag(Flag.MaraKnown);
                player.money -= 300;
                Global.global.gui()
                      .choose(this, "Leave");
                acted = true;
        ...
        if (choice.equals("Jewel: $300")) {
            if (player.money >= 300) {
                ...
                Global.global.flag(Flag.JewelKnown);
                player.money -= 300;
                Global.global.gui()
                      .choose(this, "Leave");
                acted = true;
        ...
        if (choice.equals("Exotic Artifacts: $2500")) {
            if (player.money >= 2500) {
                ...
                Global.global.flag(Flag.blackMarketPlus);
                player.money -= 2500;
                Global.global.gui()
                      .choose(this, "Leave");
                acted = true;
        ...
        if (choice.equals("Body Shop: $2500")) {
            if (player.money >= 2500) {
                ...
                Global.global.flag(Flag.bodyShop);
                player.money -= 2500;
                Global.global.gui()
                      .choose(this, "Leave");
                acted = true;
        ...
        if (choice.equals("Magic?: $2500")) {
            if (player.money >= 2500) {
                ...
                Global.global.flag(Flag.magicstore);
                player.money -= 2500;
                Global.global.gui()
                      .choose(this, "Leave");
                acted = true;
        ...
        if (choice.equals("Tech: $2500")) {
            if (player.money >= 2500) {
                ...
                Global.global.flag(Flag.workshop);
                player.money -= 2500;
                Global.global.gui()
                      .choose(this, "Leave");
                acted = true;
        ...
        if (choice.equals("Select Competitors")) {
            ...
            Global.global.everyone().stream()
                  .filter(c -> !c.human())
                  .filter(c -> !Global.global.checkCharacterDisabledFlag(c))
                  .forEach(character -> Global.global.gui().choose(this, String.format(REMOVE_PREFIX + "%s", character.getName())));
            Global.global.everyone().stream()
                  .filter(c -> !c.human())
                  .filter(c -> Global.global.checkCharacterDisabledFlag(c) && !c.getType().equals("Yui"))
                  .forEach(character -> Global.global.gui().choose(this, String.format(RETURN_PREFIX + "%s", character.getName())));
        ...
        if (choice.startsWith(REMOVE_PREFIX)) {
            ...
            Global.global.setCharacterDisabledFlag(Global.global.getCharacterByName(name));
            Global.global.gui()
        ...
        if (choice.startsWith(RETURN_PREFIX)) {
            ...
            Global.global.unsetCharacterDisabledFlag(Global.global.getCharacterByName(name));
            Global.global.gui()
                  .choose(this, "Select Competitors");
            return;
        }
        if (choice.equals("More Competitors")) {
            if (!Global.global.checkFlag(Flag.Reyka) && Global.global.checkFlag(Flag.blackMarketPlus)) {
                Global.global.gui()
            ...
            if (!Global.global.checkFlag(Flag.Kat) && Global.global.checkFlag(Flag.magicstore)) {
                Global.global.gui()
            ...
            for (Character c : Global.global.allNPCs()) {
                if (c.isCustomNPC() && !Global.global.everyone()
                                              .contains(c)) {
                    NPC npc = (NPC) c;
            ...
            if (!Global.global.checkFlag(Flag.Eve) && Global.global.checkFlag(Flag.blackMarketPlus)
                            && player.getRank() >= 2) {
                Global.global.gui()
        ...
        if (customNPCChoices.containsKey(choice)) {
            ...
            try {
                ...
                if (data.effects.stream()
                    ...
                    acted = true;
                    Global.global.newChallenger(npc.ai);
                } else {
                    Global.global.gui()
        ...
        if (choice.equals("Reyka: $1000")) {
            if (player.money >= 1000) {
                ...
                acted = true;
                Global.global.newChallenger(Global.global.getNPCByType(new Reyka().getType()).ai);
                Global.global.flag(Flag.Reyka);
            } else {
                Global.global.gui()
                      .message("You don't have enough money<br/><br/>");
            }
        ...
        if (choice.equals("Kat: $1000")) {
            if (player.money >= 1000) {
                ...
                acted = true;
                Global.global.newChallenger(Global.global.getNPCByType(new Kat().getType()).ai);
                Global.global.flag(Flag.Kat);
            } else {
                Global.global.gui()
                      .message("You don't have enough money<br/><br/>");
            }
        ...
        if (choice.equals("Eve: $1000")) {
            if (player.money >= 1000) {
                ...
                acted = true;
                Global.global.newChallenger(Global.global.getNPCByType(new Eve().getType()).ai);
                Global.global.flag(Flag.Eve);
            } else {
                Global.global.gui()
                      .message("You don't have enough money<br/><br/>");
            }
        ...
        if (choice.equals("Competition Info")) {
            ...
            for (Character npc : Global.global.everyone()) {
                if (!npc.human() && !Global.global.checkCharacterDisabledFlag(npc)) {
        ...
        if (choice.equals("Help with Addiction")) {
            Addiction add = Global.global.getPlayer()
            ...
            if (!Global.global.checkFlag(Flag.AddictionAdvice)) {
                ...
                Global.global.flag(Flag.AddictionAdvice);
            }
            Global.global.gui().message(message);
        }
        if (!Global.global.checkFlag(Flag.basicStores)) {
            Global.global.gui()
                  .choose(this, "Purchasing supplies");
        }
        if (!Global.global.checkFlag(Flag.girlAdvice)) {
            Global.global.gui()
                  .choose(this, "The Competition");
        }
        if (!Global.global.checkFlag(Flag.meditation)) {
            Global.global.gui()
                  .choose(this, "Meditation: $200");
        }
        if (Global.global.checkFlag(Flag.basicStores) && !Global.global.checkFlag(Flag.blackMarket)) {
            Global.global.gui()
                  .choose(this, "Black Market: $400");
        }
        if (Global.global.checkFlag(Flag.girlAdvice) && !Global.global.checkFlag(Flag.CassieKnown)) {
            Global.global.gui()
                  .choose(this, "Cassie: $300");
        }
        if (Global.global.checkFlag(Flag.girlAdvice) && !Global.global.checkFlag(Flag.AngelKnown)) {
            Global.global.gui()
                  .choose(this, "Angel: $300");
        }
        if (Global.global.checkFlag(Flag.girlAdvice) && !Global.global.checkFlag(Flag.MaraKnown)) {
            Global.global.gui()
                  .choose(this, "Mara: $300");
        }
        if (Global.global.checkFlag(Flag.girlAdvice) && !Global.global.checkFlag(Flag.JewelKnown)) {
            Global.global.gui()
                  .choose(this, "Jewel: $300");
        }
        if (Global.global.checkFlag(Flag.rank1)) {
            if (Global.global.checkFlag(Flag.blackMarket) && !Global.global.checkFlag(Flag.blackMarketPlus)) {
                Global.global.gui()
                      .choose(this, "Exotic Artifacts: $2500");
            }
            if (!Global.global.checkFlag(Flag.bodyShop)) {
                Global.global.gui()
                      .choose(this, "Body Shop: $2500");
            }
            if (Global.global.checkFlag(Flag.meditation) && !Global.global.checkFlag(Flag.dojo)) {
                Global.global.gui()
                      .choose(this, "Martial Arts: $2500");
            }
            if (!Global.global.checkFlag(Flag.workshop)) {
                Global.global.gui()
                      .choose(this, "Tech: $2500");
            }
            if (!Global.global.checkFlag(Flag.magicstore)) {
                Global.global.gui()
    ...
    public boolean newCharacters() {
        return Global.global.checkFlag(Flag.rank1);
    }
}
