    ...
    public void visit(String choice, int page, List<LabeledValue<String>> nextChoices, ActivityInstance instance) {
        ...
        if (!Flag.checkFlag(Flag.metAisha)) {
            ...
            if (player.money >= 1000 * (player.getPure(Attribute.Arcane) + 1)) {
                ...
                switch (scene) {
                    case 0:
                        GUI.gui.message("Aisha nods and waves her hand through the air. As she does so, you feel the world around you shift and a huge wave of nausea "
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        GUI.gui.message("Aisha grins and as per usual you find yourself in the training room, this time there's a bunch of mannequins with random assortments of "
                        ...
                        break;
                    default:
                        GUI.gui.message("Aisha pauses and closes her eyes briefly before grinning and bringing you both to the training room. This time Aisha arrives before you... All four of "
            ...
            GUI.gui.message("You bring up the topic of Kat's animal spirit and "
