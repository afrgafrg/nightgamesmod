    ...
    public void visit(String choice, int page, List<LabeledValue<String>> nextChoices, ActivityInstance instance) {
        ...
        if (Flag.checkFlag(Flag.dojo) && choice.equals("Start")) {
            if (!Flag.checkFlag(Flag.metSuzume)) {
                GUI.gui.message("You go to the Suzuki dojo to meet Suzume. She looks like she's trying to looks like project the air of a dignified martial arts master, but "
            ...
            GUI.gui.message("You contact Suzume and schedule a private meditation session. Dropping Aesop's name saved a lot of time; she didn't ask many questions. Apparently "
