...
public class Threesomes extends DaytimeEvent {
    ...
    public Threesomes(Character player) {
        ...
        if (Global.global.getNPC("Cassie")
                  .getAffection(player) >= 20 && Global.global.getNPC("Jewel")
                                 .getAffection(player) >= 20
                        && Global.global.getNPC("Jewel").getAffection(Global.global.getNPC("Cassie")) >= 5) {
        ...
        if (Global.global.getNPC("Mara")
                  .getAffection(player) >= 20 && Global.global.getNPC("Jewel")
                                 .getAffection(player) >= 20
                        && Global.global.getNPC("Jewel").getAffection(Global.global.getNPC("Mara")) >= 5) {
            register("MaraJewel", 5);
        }
        if (Global.global.getNPC("Mara")
                  .getAffection(player) >= 15 && Global.global.getNPC("Angel")
                                 .getAffection(player) >= 15
                        && Global.global.getNPC("Angel").getAffection(Global.global.getNPC("Mara")) >= 10) {
            register("AngelMara", 5);
        }
        if (Global.global.getNPC("Mara")
                  .getAffection(player) >= 15 && Global.global.getNPC("Cassie")
                                 .getAffection(player) >= 15
                        && Global.global.getNPC("Cassie").getAffection(Global.global.getNPC("Mara")) >= 10) {
            ...
            case "CassieJewel":
                Global.global.gui()
                      .message("You step out of the shower room with a towel wrapped around your waist to preserve your modesty. One of these days you should get a proper bathrobe, "
                                      ...
                                      + "uncharacteristically bold. Whatever the reason and despite the bizarre situation, you're rock hard.<br/><br/>"
                                      ...
                                      + "<i>\"In case you've forgotten how good we are together, I'll give you a reminder.\"</i><br/><br/>"
                                      ...
                                      + "can at least imagine that Jewel may finish when you do. You can't see Cassie, but you at least hear her breathy moans.<br/><br/>"
                                      ...
                                      + "she hasn't you're not going to let her go anywhere until you've shown your appreciation.<br/><br/>"
            ...
            case "MaraJewel":
                Global.global.gui()
                      .message("You're sitting in your room, working on some homework, when you hear a knock on your door. You open the door to find Mara, who pushes past you into "
                                      ...
                                      + "why she's here. <i>\"Yeah, I know. To be honest, I was just trying to keep your attention away from the door while she sneaks up behind you.\"</i><br/><br/>"
                                      ...
                                      + "Mara giggles and starts to stroke your dick. <i>\"We like this boy a lot. Besides, he's already hard from listening to us. Pleasure it is.\"</i><br/><br/>"
                                      ...
                                      + "completely at her mercy. She could give you as much pleasure or pain as she wants. You should prostrate yourself in gratitude for her kindness.\"</i><br/><br/>"
                                      ...
                                      + "into the air like a fountain, to the amusement of both girls.<br/><br/>"
            ...
            case "CassieMara":
                Global.global.gui()
                      .message("You return to your room after a brief errand. As you reach for the doorknob, the muffled sound of female voices inside makes you "
                                      ...
                                      + "of her bare breasts. Mara, on the other hand, hops out of bed and scampers over to you as naked as the day she was born.<br/><br/>"
                                      + "<i>\"Ah! You're back early! We were preparing a little surprise for you, but we need a couple more minutes.\"</i><br/>"
                                      + "She doesn't appear at all bothered by her nudity, but Cassie starts to freak out a bit.<br/><br/>"
                                      + "<i>\"Mara! You're standing in the doorway to a public hallway completely naked! Get back in here and close the door before someone sees you!\"</i><br/><br/>"
                                      ...
                                      + "finish getting ready. I promise you'll love it.\"</i> She closes the door and you hear her footsteps trot back to the bed.<br/><br/>"
                                      ...
                                      + "patterns in the dessert, but maybe she was just trying to get a taste.<br/><br/>"
                                      ...
                                      + "for your birthday,\"</i> Cassie explains. <i>\"But someone got impatient and said we should just do it now.\"</i><br/><br/>"
                                      ...
                                      + "this whipped cream won't stay solid very long at body temperature.\"</i><br/><br/>"
                                      ...
                                      + "much as you and Mara. You give her a tender kiss and promise you'll attend to her soon, then you turn your attention to the whipped cream on Mara's belly.<br/><br/>"
                                      ...
                                      + "<i>\"You're tickling me on purpose! Quit teasing me and get to the good parts!.\"</i> Is she ready for something more stimulating? There's a way to find out.<br/><br/>"
                                      ...
                                      + "melted puddle of shivering pleasure by the time you turn your attention to the remaining whipped cream concealing her slit.<br/><br/>"
                                      ...
                                      + "Cassie actually has to cover her mouth to keep her scream from echoing through the entire building.<br/><br/>"
                                      ...
                                      + "He's obviously ready to go, and I'm willing to bet you are too.\"</i><br/><br/>"
                                      ...
                                      + "mind putting of your own satisfaction for a bit. Beside, when you look at Cassie's chocolate-covered body, the idea of eating your dessert first is pretty tempting.<br/><br/>"
                                      ...
                                      + "toward climax. Mara, having recovered from her earlier orgasm, leans over her friend's neglected breasts.<br/><br/>"
                                      ...
                                      + "sex with girls outside of the Games!\"</i><br/><br/>"
                                      ...
                                      + "in. I hope you don't hate me for it.</i>\"<br/><br/>"
            ...
            case "AngelMara":
                Global.global.gui()
                      .message("'Cum over ASAP.'<br/><br/>"
                                      ...
                                      + "some giggling from within and the door opens a few seconds later.<br/><br/>"
                                      ...
                                      + "heart race at this unexpected sign of affection.<br/><br/>" + "*Thud*<br/><br/>"
                                      ...
                                      + "complete the set, enveloping each of her slender legs.<br/><br/>"
                                      ...
                                      + "are going to be our test dummy. Now don't act unless I tell you to, we're the ones seducing you.\"</i><br/><br/>"
                                      ...
                                      + "<i>\"I hope you listened to her. We got all dressed up for you, in our slutty little stockings and negligee.\"</i><br/><br/>"
                                      ...
                                      + "she has adorned a candy camisole. It is a thin garment, delicate and fragile enough that you can make it the smooth, soft surface of her skin beneath it.<br/><br/>"
                                      ...
                                      + "soundly massage your tired muscles. You groan, letting out a deep sigh of relaxation and closing your eyes.<br/><br/>"
                                      ...
                                      + "her lips planting a series of kisses up your spine, making your legs tremble at each sensual peck.<br/><br/>"
                                      ...
                                      + "now, any second and they'll-<br/><br/>" + "She suddenly withdraws her hand.<br/>"
                                      + "<i>\"Get on the bed, and strip off your bottoms. We've got a show for you\"</i> Mara winks, slapping you playfully on the cheek.<br/><br/>"
                                      ...
                                      + "the scene before you all the cuter.<br/><br/>"
                                      ...
                                      + "firmly erect. You reach down and begin slowly stroking yourself while the two girls continue to perform their show of seduction for you.<br/><br/>"
                                      ...
                                      + "their attentions back to you and your stiff member. <br/><br/>"
                                      ...
                                      + "straddling over your waist, parting her silk-soft panties and slipping your cock your shaft into her sweltering snug pussy.<br/><br/>"
                                      ...
                                      + "You lap wildly at Mara's pearl, making her squirm and writhe in a fit of ecstasy.<br/><br/>"
                                      ...
                                      + "Angel leans over, grabbing her and pulling her into a passionate kiss, the two girls mouths locked together while they ride your body for their pleasure.<br/><br/>"
    ...
    @Override boolean available() {
        return !Global.global.checkFlag(Flag.threesome);
    }
