...
public class VideoGames extends Activity {
    ...
    private void showScene(Scene chosen) {
        switch (chosen) {
            ...
            case cassie1:
                ...
                Global.global.flag(Flag.Cassievg1);
                break;
            case cassie2:
                Global.global.gui().message(
                ...
                player.gainAffection(Global.global.getNPC("Cassie"), 1);
                Global.global.getNPC("Cassie").gainAffection(player, 1);
                Global.global.flag(Flag.Cassievg2);
                break;
            case mara1:
                Global.global.gui().message(
                ...
                player.gainAffection(Global.global.getNPC("Mara"), 1);
                Global.global.getNPC("Mara").gainAffection(player, 1);
                Global.global.flag(Flag.Maravg1);
                break;
            case mara2:
                Global.global.gui().message(
                ...
                player.gainAffection(Global.global.getNPC("Mara"), 1);
                Global.global.getNPC("Mara").gainAffection(player, 1);
                Global.global.flag(Flag.maravg2);
                break;
            case cassiemara:
                Global.global.gui().message(
                ...
                Global.global.getNPC("Mara").gainAffection(Global.global.getNPC("Cassie"), 1);
                Global.global.getNPC("Cassie").gainAffection(Global.global.getNPC("Mara"), 1);
                break;
            case caroline1:
                Global.global.gui().message(
                ...
                Global.global.modCounter(Flag.CarolineAffection, 1.0F);
                break;
            case caroline2:
                Global.global.gui().message(
    ...
    private Scene pickScene() {
        ...
        if (player.getAffection(Global.global.getNPC("Cassie")) >= 5) {
            available.add(Scene.cassie1);
        }
        if (player.getAffection(Global.global.getNPC("Cassie")) >= 10 && Global.global.checkFlag(Flag.Cassievg1)) {
            available.add(Scene.cassie2);
        }
        if (player.getAffection(Global.global.getNPC("Mara")) >= 5) {
            available.add(Scene.mara1);
        }
        if (player.getAffection(Global.global.getNPC("Mara")) >= 10 && Global.global.checkFlag(Flag.Maravg1)) {
            available.add(Scene.mara2);
        }
        if (Global.global.getNPC("Cassie").getAffection(Global.global.getNPC("Mara")) >= 10 && Global.global
                        .checkFlag(Flag.Cassievg2) && Global.global.checkFlag(Flag.maravg2)) {
            available.add(Scene.cassiemara);
        }
        if (player.getAffection(Global.global.getNPC("Angel")) >= 10) {
            available.add(Scene.caroline1);
        }
        if (Global.global.getValue(Flag.CarolineAffection) >= 3.0F) {
