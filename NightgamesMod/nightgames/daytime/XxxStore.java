    ...
    public void visit(String choice) {
        ...
        if (player.human()) {
            ...
            if (player.hasDick()) {
                ...
                sale(Item.Strapon, GUI.gui);
            }
            sale(Item.Blindfold, GUI.gui);
            displayClothes();
