        ...
        if (response.equals("Volunteer")) {
            ...
            if (!Global.global.checkFlag(Flag.didFTC)) {
                message = "\"No one? Really? Fine, then I'll pick someone. Let's see... " + prey.name()
                                ...
                                + " briefly seems nervous, but then shrugs and ditches all of " + prey
                                .possessiveAdjective() + " clothing and gets in the van. The rest of you pile in as well,"
