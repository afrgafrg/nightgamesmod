        ...
        switch (goal) {
            ...
            case peggedloss:
                return "Getting pegged in the ass is a hell of a thing, isn't it. I sympathize... especially since "
                                + target.name() + " seems to have it in for you tonight. If it "
            ...
            case pendomwin:
                return "How good are you exactly? If you want to show " + target.name()
            ...
            case pendraw:
                return "Some things are better than winning, like cumming together with your sweetheart. You and "
                                + target.name() + " seem pretty sweet.";
            case subwin:
                return "Everyone loves an underdog. If you can win a fight with " + target.name()
