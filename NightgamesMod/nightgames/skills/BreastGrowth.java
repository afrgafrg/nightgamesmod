    ...
    public String deal(Combat c, int damage, Result modifier, Character target) {
        ...
        if (modifier == Result.normal) {
            message = String.format(
                            ...
                            Grammar.capitalizeFirstLetter(target.possessiveAdjective()), target.possessiveAdjective());
            if (damage > 0) {
    ...
    public String receive(Combat c, int damage, Result modifier, Character target) {
        ...
        if (modifier == Result.normal) {
            message = String.format(
                            ...
                            getSelf().name(), Grammar.capitalizeFirstLetter(target.subjectAction("feel")),
            ...
            if (damage > 0) {
                message += Grammar.capitalizeFirstLetter(target.subjectAction("realize"))
            ...
            message = String.format(
                            ...
                            Grammar.capitalizeFirstLetter(target.subjectAction("start")), target.possessiveAdjective(),
