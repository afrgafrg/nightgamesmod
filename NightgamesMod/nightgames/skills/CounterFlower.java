...
public class CounterFlower extends CounterBase {
    public CounterFlower(Character self) {
        super("Flower Counter", self, 5, Global.global.format(
    ...
    public String deal(Combat c, int damage, Result modifier, Character target) {
        if (modifier == Result.setup) {
            return Global.global.format("You open up the flower at the base of your legs and get ready for a counter.",
                            getSelf(), target);
