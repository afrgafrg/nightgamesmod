...
public class HeightenSenses extends Skill {
    ...
    public boolean resolve(Combat c, Character target) {
        ...
        if (!alreadyTranced && Rng.rng.random(3) == 0) {
            ...
            return false;
        } else if (target.is(Stsflag.hypersensitive) && Rng.rng.random(2) == 0) {
            if (getSelf().human()) {
