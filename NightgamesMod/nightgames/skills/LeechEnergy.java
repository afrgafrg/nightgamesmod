    ...
    public boolean resolve(Combat c, Character target) {
        if (target.roll(getSelf(), c, accuracy(c, target))) {
            ...
            while (!targets.isEmpty()) {
                String type = targets.remove(Global.global.random(targets.size()));
            ...
            if (part.isType("hands")) {
                c.write(getSelf(),
                                Global.global.format("{self:name-possessive} numerous " + selfPart.describe(getSelf())
                ...
                c.write(getSelf(), Global.global.format("A thick " + partStringSingular
                ...
                c.write(getSelf(), Global.global.format("A particularly thick " + partStringSingular
            ...
            target.drainStaminaAsMojo(c, getSelf(), 10 + Global.global.random(20), 1.5f);
            target.body.pleasure(getSelf(), selfPart, part, 10 + Global.global.random(20), c, this);
        } else {
