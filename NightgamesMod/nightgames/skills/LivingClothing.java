...
public class LivingClothing extends Skill {
    ...
    public boolean resolve(Combat c, Character target) {
        ...
        getSelf().getOutfit().equip(ClothingTable.getByID("tentacletop"));
        getSelf().getOutfit().equip(ClothingTable.getByID("tentaclebottom"));
        return true;
    }
    ...
    public String receive(Combat c, int damage, Result modifier, Character target) {
        ...
        message = String.format("With a grimace, %s powers up %s fabricator and dials the "
                        ...
                        getSelf().possessiveAdjective(), Formatter.capitalizeFirstLetter(getSelf().pronoun()),
