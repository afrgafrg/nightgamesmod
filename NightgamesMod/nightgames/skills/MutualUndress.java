...
public class MutualUndress extends Skill {
    ...
    public String deal(Combat c, int damage, Result modifier, Character target) {
        return Formatter.format("During a brief respite in the fight as {other:subject}" 
                        + " is catching {other:possessive} breath, you ask if we can finish the fight naked. "
                        + "Without waiting for an answer, you slowly strip off all your clothing."
                        + "By the time you finish, you find that {other:pronoun} has also stripped naked while panting with arousal.",
                        getSelf(), target);
    }
