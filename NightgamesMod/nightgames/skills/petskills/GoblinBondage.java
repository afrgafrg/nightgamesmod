...
public class GoblinBondage extends SimpleEnemySkill {
    ...
    public boolean resolve(Combat c, Character target) {
        c.write(getSelf(), Global.global.format("{self:SUBJECT} pulls the bondage straps tighter around herself. You can see the leather and latex digging into her skin as "
