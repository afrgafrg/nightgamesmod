    ...
    public boolean resolve(Combat c, Character target) {
        if (target.roll(getSelf(), c, accuracy(c, target))) {
            ...
            if (target.crotchAvailable() && !c.getStance().penisInserted(target) && target.hasDick()) {
                c.write(getSelf(), Global.global.format("{self:SUBJECT} jumps onto {other:name-do} and humps at {other:possessive} dick before "
                ...
                c.write(getSelf(), Global.global.format("{self:SUBJECT} latches onto {other:name-do} and shoves {self:possessive} thick cock into {other:possessive} pussy. As the demon humps {other:direct-object}, {other:SUBJECT-ACTION:yell|shrieks} and punches {self:direct-object} away.",
                                getSelf(), target));
                ...
                c.write(getSelf(), Global.global.format("{self:SUBJECT} jumps up and hugs {other:name-possessive} chest and licks {other:possessive} nipples with "
        ...
        c.write(getSelf(), Global.global.format("{self:SUBJECT} stands at the periphery of the fight, touching {self:reflective} idly.", getSelf(), target));
        return false;
    }
