    ...
    public boolean resolve(Combat c, Character target) {
        if (target.roll(getSelf(), c, accuracy(c, target))) {
            ...
            if (target.crotchAvailable() && !c.getStance().penisInserted(target) && target.hasDick()) {
                c.write(getSelf(), Global.global.format("{self:SUBJECT} forms into a humanoid shape and grabs {other:name-possessive} dick. "
                ...
                c.write(getSelf(), Global.global.format("Two long appendages extend from {self:name-do} and wrap around {other:name-possessive} legs. "
                ...
                c.write(getSelf(), Global.global.format("{self:SUBJECT} grows two long slimy appendages which rises up and tweaks {other:name-possessive} "
                                + "sensitive nipples.",
                                getSelf(), target));
        ...
        c.write(getSelf(), Global.global.format("You see eyes form in {self:name-do} as it watches the fight curiously.", getSelf(), target));
        return false;
    }
