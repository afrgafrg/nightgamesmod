...
public class Oiled extends Status {
    ...
    public double pleasure(Combat c, BodyPart withPart, BodyPart targetPart, double x) {
        c.write(affected, Global.global.format("{self:NAME-POSSESSIVE} slippery oiled form makes {self:direct-object} all the more sensitive.", affected, c.getOpponent(affected)));
        return x / 4;
    }
