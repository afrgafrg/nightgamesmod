        ...
        switch (getSeverity()) {
            case HIGH:
                ...
                return "You wake up in the morning with a burning need for " + cause.name() + "'s milk. The thought of resisting the urge doesn't even enter your mind. You quickly whip out your cellphone and dial " + cause.name() + "'s number. "
                                ...
                                + Grammar.capitalizeFirstLetter(cause.pronoun()) + " pats " + cause.directObject() + " lap and motions for you to strip and lie down. You quickly comply and lay in " + cause.directObject() + " lap facing the ceiling, giddy for more milk. <br/>"
